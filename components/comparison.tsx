  ...
  return (
    <li className="flex items-center space-x-3">
      <div className="bg-[#918F90] w-11 h-11 text-primary-foreground flex items-center justify-center shrink-0">
        <Image src={feature.icon} alt={feature.description} width={20} height={20} />
      </div>
    ...
    <div className="bg-gray-50 py-16 sm:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:text-center">
          <h2 className="text-base text-indigo-600 font-semibold tracking-wide uppercase">Porównanie</h2>
        ...
        <div className="mt-16">
          <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
            {[
              ...
              <h2 className="text-2xl font-semibold text-gray-900 mb-6">{section.name}</h2>
